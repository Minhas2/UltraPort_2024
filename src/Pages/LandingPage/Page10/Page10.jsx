      ...
      <div className='page-10'>
        ...
        <div className='container '>
          ...
          <div className='image-container'>
            <img src={`${imgURL}/page10-1.jpg`} className='w-100' />
          </div>


          <div className='image-container'>
            <img src={`${imgURL}/page10-2.jpg`} className='w-100' />
          </div>


          <div className='image-container '>
            <img src={`${imgURL}/page10-3.jpg`} className='w-100' />
          </div>

          <div className='image-container '>
            <img src={`${imgURL}/page10-4.jpg`} className='w-100' />
          </div>
