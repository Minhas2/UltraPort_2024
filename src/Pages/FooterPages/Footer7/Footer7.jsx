  ...
  const FAQItem = ({ question, answer }) => {
    ...
    return (
      <div className="faq-item mb-3">
        ...
        >
          <h5 className="m-0 bold faq-question">{question}</h5>
        ...
        <div className='fluid-cotainer section-2'>
          ...
          <div className='container py-5'>
            ...
            <div className='content'>
              ...
              <h1 className='mb-4'>Le processeur, c’est quoi ?</h1>

              <p className='mb-4'>Le CPU (Core Processing Unit), ou processeur PC, est le cerveau de vos appareils électroniques, que ce soit votre ordinateur, smartphone, smartwatch, PC portable, console de jeu ou autre. C'est-à-dire que son rôle principal est de traiter et d'organiser les nombreuses données numériques, et de les échanger entre les composants de votre PC.</p>

              <p className='mb-4'>Composé de semi-conducteurs, le processeur PC est un petit composant de forme généralement carrée, de quelques millimètres d’épaisseur. Le processeur se branche sur la carte mère. Vous ne pouvez cependant pas l’apercevoir dans votre PC, car il est situé derrière son système de refroidissement. </p>

              <p className='mb-4'>Le processeur PC peut être considéré comme la pièce centrale. Ses fonctions en font le chef d’orchestre de votre configuration. Il va donc sans dire qu'il est préférable de choisir le meilleur processeur, si vous souhaitez que votre ordinateur personnel assure une fluidité exemplaire dans toutes les taches, comme les jeux vidéo par exemple.</p>

              <p className='mb-4'>Les meilleurs processeurs grand public répartis en plusieurs catégories, pouvant être résumées au potentiel de puissance de calcul pouvant être généré. Vous avez probablement déjà entendu parler de processeurs Intel, AMD Ryzen 5, AMD Ryzen 7 ou encore AMD Ryzen 9 ? Ces composants High-Tech au rapport qualité-prix imbattable sont un bon plan au top et sont disponibles aux meilleurs prix.</p>

              <p className='mb-4'>Des processeurs d’entrée de gamme puissent faire l’affaire pour certains types de jeux. Cependant, il est généralement conseillé d’opter pour le milieu de gamme ou bien le haut de gamme en fonction de vos attentes en termes de gaming.</p>


              <p className='mb-4'>Les processeurs bénéficiant de plus de cœurs pourront calculer plus d’informations simultanément. Les processeurs modernes disposent en plus de la technologie Hyper-Threading ou Multithreading. Le Multithreading permet à chaque coeur de CPU de se plier en deux, afin de procéder à plusieurs calculs en même temps. Cela revient à créer des cœurs supplémentaires virtuels. De cette manière, un processeur Ryzen à 6 cœurs bénéficie d’une capacité de calcul équivalente à un CPU 12 cœurs.</p>


              <p className='mb-4'>Les jeux actuels sont optimisés pour tirer parti d’un nombre de cœurs élevé. Cependant, il n’est pas nécessaire d’opter pour un processeur avec le plus grand nombre de cœurs disponibles. En moyenne, les jeux actuels sont optimisés pour tirer parti de 4 à 6 cœurs. Certains jeux plus demandeurs en termes de ressources de calcul peuvent monter au-delà.</p>

              <p className='mb-4'>Voici un tableau représentant les besoins en termes de cœurs pour quelques jeux populaires : </p>
              ...
              <p className='mb-4'>Un PC intégrant un processeur d’entrée de gamme comme un processeur Intel Core i3 ou AMD Ryzen 3 vous permettra déjà de jouer à des jeux pour lesquels les développeurs ne recommandent que quelques cœurs.</p>

              <p className='mb-4'>Si vous optez pour le milieu de gamme, par exemple un Intel Core i5 ou un AMD Ryzen 5, vous serez paré pour la grosse majorité des jeux actuels.</p>

              <p className='mb-5'>Vous pouvez opter pour un processeur haut de gamme, Intel Core i7 ou AMD Ryzen 7 ou supérieur comme un AMD Ryzen 9, si vous souhaitez demander à votre PC plus que “simplement” du jeu. Cela vous permettra de vous adonner au streaming ou au montage vidéo entre autres.</p>


              <h1 >Comparatif processeur</h1>
              <p className='mb-4'>Quel processeur choisir ? Comment choisir le meilleur processeur ?
              </p>

              <p className='mb-4'>Le premier choix qui va s’imposer à vous est celui du fabricant. Ce choix peut paraitre difficile, voire cornélien.</p>

              <p className='mb-4'>Essayons de tirer tout cela au clair.</p>

              <p className='mb-4'>Il s’agit avant tout d’un choix de préférence de marque. Les idées reçues ont la peau dure. Il est fréquent d’entendre “un processeur Intel Core est mieux pour le gaming”, ou bien “un processeur AMD Ryzen c'est moins cher”, "Les processeurs Intel chauffent plus"ou encore “il y a moins de bugs sur Intel Core”. Qu’en est-il vraiment ?</p>

              <p className='mb-4'>Les nombreux comparatifs et benchmarks processeur que l’on peut trouver indiquent que finalement ce choix n’est pas si déterminant que cela. Un processeur Intel Core ou AMD Ryzen offre des performances relativement équivalentes sur des modèles de gamme et de génération similaires. Il suffit de regarder des comparatifs de performance pour s’en rendre compte. Certains jeux fonctionnent légèrement mieux sur des processeurs Intel, et d’autres sur un processeur AMD Ryzen. Il n’y a donc pas de réponse toute faite à ce sujet.</p>

              <p className='mb-4'>Il est donc essentiel, en tant que consommateur, de se poser les bonnes questions :
              </p>
          ...
          <div className='container '>
            ...
            <div className='content'>
              ...
              <table class="table table-bordered table-dark my-5">
                <thead>
                  <tr>
                    <th scope="col">marque du CPU	</th>
                    <th scope="col">type de socket	</th>
                    <th scope="col">CPU</th>
                    <th scope="col">chipsets compatibles</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td>LGA 1700	</td>
                    <td>12th Gen Core	</td>
                    <td>Z690, H670, B660, H610	</td>
                  </tr>
                  <tr>
                    <td>Intel</td>
                    <td>LGA 1200	</td>
                    <td>11th Gen Core, 10th Gen Core</td>
                    <td>Z490, H470, B460, H410</td>
                  </tr>
                  <tr>
                    <td>Intel</td>
                    <td>Intel 1151		</td>
                    <td>	9th Gen Core, 8th Gen Core</td>
                    <td>Z390, Z370, Z370, Q370, H370, B365, B360, H310</td>
                  </tr>
                  <tr>
                    <td>AMD</td>
                    <td>AM4</td>
                    <td>	Ryzen 5000, 3000, 2000 et 1000</td>
                    <td>X570, X470, X370, B550, B450, B350, B450, A320, X300, A300</td>
                  </tr>
                </tbody>
              </table>
              ...
              <p className='mb-4'>Les chipsets compatibles avec les différents modèles y sont également listés.
              </p>

              <p className='mb-4'> Le chipset (ou la puce) de la carte mère est une sorte de miniprocesseur intégré à celle-ci. Ce chipset assure le transfert des informations entre vos composants. Il est prévu pour fonctionner avec des générations de processeurs données. </p>

              <p className='mb-4'>Tout comme le reste de la configuration, il est recommandé de choisir un chipset de gamme correspondante à celle de votre processeur.</p>

              <p className='mb-4'>Brancher un processeur haut de gamme sur une carte mère avec un chipset d’entrée de gamme ne vous donnera pas grand-chose, si ce n'est des résultats mitigés, au mieux.</p>



              <h4 className='mt-5 mb-4'>Refroidissement de votre processeur
              </h4>
              <p className='mb-4'>L’un des composants les plus importants à associer à votre processeur est le système de refroidissement. En effet, même le meilleur va beaucoup chauffer en utilisation de part ses réflexions intenses et constantes. Afin de l’aider à garder la tête froide, le processeur doit être équipé d’un système de refroidissement. Contrairement à un PC portable, plusieurs options sont à votre disposition dans une tour PC.</p>

              <p className='mb-4'>On trouve actuellement deux familles principales de refroidissement :</p>
              ...
              <p className='mb-4'>En règle générale, l'un des nombreux processeurs grand public actuels des gammes Intel Core et AMD Ryzen devrait répondre à vos attentes. Nous recommandons d'opter pour les dernières générations disponibles afin de vous assurer de la meilleure compatibilité, avec vos derniers appareils USB-C par exemple. Opter pour les derniers composants à l'achat vous assure aussi une meilleure longévité.</p>
